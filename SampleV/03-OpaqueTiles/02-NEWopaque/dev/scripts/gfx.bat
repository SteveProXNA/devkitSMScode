...
bmp2tile.exe raw/game_tiles.png -savetiles "game_tiles (tiles).psgcompr" -noremovedupes -planar -tileoffset 64 -savetilemap "game_tiles (tilemap).bin" -infrontofsprites -savepalette "game_tiles (palette).bin" -fullpalette -exit

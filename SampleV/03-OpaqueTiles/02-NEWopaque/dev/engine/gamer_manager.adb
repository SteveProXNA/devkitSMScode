...
S:Lgamer_manager.engine_gamer_manager_init$px$1_0$85({1}SC:U),B,1,4
S:Lgamer_manager.engine_gamer_manager_init$py$1_0$85({1}SC:U),B,1,5
S:Lgamer_manager.engine_gamer_manager_init$vel$1_0$85({1}SC:U),B,1,6
S:Lgamer_manager.engine_gamer_manager_init$tile$1_0$85({2}SI:U),B,1,7
S:Lgamer_manager.engine_gamer_manager_init$go$1_0$86({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
F:G$engine_gamer_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgamer_manager.engine_gamer_manager_update$dx$1_0$87({1}SC:U),B,1,4
S:Lgamer_manager.engine_gamer_manager_update$dy$1_0$87({1}SC:U),B,1,5
S:Lgamer_manager.engine_gamer_manager_update$go$1_0$88({2}DG,STtag_struct_gamer_object:S),R,0,0,[e,d]
F:G$engine_gamer_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgamer_manager.engine_gamer_manager_draw$go$1_0$89({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
